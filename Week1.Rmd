...
-1. How is the trend of  Nutritional Deficiency deaths worldwide from 1990?  

-2.  countries in the world with the highest deaths caused by Nutritional Deficiencies.  

-3. What are the preventive measures those countries can take to reduce these deaths? 
]
...
```{r, echo = FALSE, message = FALSE}
#top 5 countries with highest death rates
